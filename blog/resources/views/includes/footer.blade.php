        ...
        <div class="footer-top">
            <div class="footer-grids">
                <div class="col-md-3 f-address">
                    <h5>Address</h5>
                    <ul>
                        <li>1020 Lowry Street,</li>
                        <li>Columbia, MO 65201</li>
                        <li>Telephone: +1 573 889 1233</li>
                        <li>FAX: +1 234 567 9871</li>
                        <li>E-mail : <a href="mailto:RandallCapstone@gmail.com">RandallCapstone@gmail.com</a></li>
                    </ul>
                </div>
